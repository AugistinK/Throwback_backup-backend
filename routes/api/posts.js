...
// Import post upload middleware
const postUploadMiddleware = require('../../middlewares/upload.post.middleware');

// Post routes
router.get('/', optionalAuth, postController.getPosts);
router.post('/', protect, postUploadMiddleware.upload, postUploadMiddleware.handleMulterError, 
            logAction('CREATION_POST', 'Création d\'un post'), postController.createPost);
...
// Post interaction routes - ensure exact parameter matching with frontend
...
// Comment routes - ensure parameter naming consistency
router.get('/:postId/comments', optionalAuth, commentController.getPostComments);
router.post('/:postId/comments', protect, logAction('AJOUT_COMMENTAIRE_POST', 'Ajout d\'un commentaire sur un post'), 
